...
class StateMachine:
    ...
    _TRANSITIONS = {
        ...
        (RobotTaskState.R_ACCEPTED, EventType.H_CANCEL): RobotTaskState.R_CANCELED,
        (RobotTaskState.R_RESUME, EventType.H_CANCEL): RobotTaskState.R_CANCELED,
        (RobotTaskState.R_REDO, EventType.H_CANCEL): RobotTaskState.R_CANCELED,
        (RobotTaskState.R_ACCEPTED, EventType.ROBOT_RUNNING): RobotTaskState.R_EXECUTING,
        (RobotTaskState.R_RESUME, EventType.ROBOT_RUNNING): RobotTaskState.R_EXECUTING,
